const css = require('./game.css');
 const js = require('./SplitText.min.js');
...
var titleText = new SplitText(".title"),
    ...
    gameContainer = document.getElementsByClassName("gameBoard"),
    dropTargets = document.getElementsByClassName("target"),
    totalTargets = 6,
    totalHit = 0;
...
function loadGameBoard(){
    TweenMax.staggerTo(".image",.2, {opacity:1, scale:1, ease:Back.easeOut, force3D: true}, .1, initDraggableItem);
}
